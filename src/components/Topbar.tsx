...
export default function Topbar() {
  return (
    <div style={{ height:'44px', background:'var(--bg1)', borderBottom:'1px solid var(--border)', display:'flex', alignItems:'center', padding:'0 1rem', gap:'.75rem', flexShrink:0, zIndex:100 }}>
      <div style={{ display:'flex', alignItems:'center', gap:'.45rem' }}>
        <div style={{ width:'22px', height:'22px', background:'var(--fp)', borderRadius:'4px', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'.75rem' }}>⚡</div>
        <span style={{ fontFamily:'monospace', fontSize:'.82rem', fontWeight:600, letterSpacing:'.04em' }}>SIE 2028</span>
        <span style={{ fontFamily:'monospace', fontSize:'.62rem', color:'var(--fp)', background:'#e8294a18', border:'1px solid #e8294a30', padding:'.08rem .35rem', borderRadius:'3px' }}>v2.0</span>
      </div>
